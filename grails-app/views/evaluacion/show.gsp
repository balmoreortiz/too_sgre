...
<html>
    ...
    <body>
        ...
        <div id="show-evaluacion" class="content scaffold-show" role="main">
            ...
            <f:display bean="evaluacion" />
            <g:form resource="${this.evaluacion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.evaluacion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
