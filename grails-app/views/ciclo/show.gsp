...
<html>
    ...
    <body>
        ...
        <div id="show-ciclo" class="content scaffold-show" role="main">
            ...
            <f:display bean="ciclo" />
            <g:form resource="${this.ciclo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.ciclo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
