...
<html>
    ...
    <body>
        ...
        <div id="edit-evaluacion" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.evaluacion}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.evaluacion}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.evaluacion}" method="PUT">
                <g:hiddenField name="version" value="${this.evaluacion?.version}" />
                <fieldset class="form">
                    <f:all bean="evaluacion"/>
                </fieldset>
